;(function(){ 'use strict';
  ...
  var register = function( cytoscape, dagre ){
    ...
    var defaults = {
      ...
      edgeSep: 400, // the separation between adjacent edges in the same rank
	...
	alert("Where am I");
      ...
      nodes.layoutPositions(layout, options, function(){
		...
		//alert(this.scratch().id);
		//console.log(this)
		//alert(this._private.data.id + " and position " + this._private.data.positionY);
        return constrainPos({
          x: dModel.x,
          y: this._private.data.positionY
        });
      });
